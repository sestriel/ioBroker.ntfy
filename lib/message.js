...
class Message {
  ...
  addAttachment(attachFromURL, filename) {
    if (attachFromURL === null || attachFromURL === "") {
      return;
    }
    if (!this.isValidUrl(attachFromURL)) {
      return;
    }
    ...
    this.attachment = {
      ...
      filename:
        filename !== null && filename !== ""
          ? filename
          : attachFromURL.substring(attachFromURL.lastIndexOf("/") + 1),
    };
  }
  ...
  toJSON() {
    return {
      ...
      ...(this.iconURL !== null &&
        this.iconURL !== "" && { icon: this.iconURL }),
      ...(this.delay !== null && this.delay !== "" && { delay: this.delay }),
      ...(this.clickURL !== null &&
        this.clickURL !== "" && { click: this.clickURL }),
      ...(this.attachment !== null && {
        attach: this.attachment.url,
